...
# Enhanced NFC
$(call inherit-product, vendor/nuclear/config/nfc_enhanced.mk)

# Inherit some common Nuclear stuff.
$(call inherit-product, vendor/nuclear/config/common_full_phone.mk)

PRODUCT_NAME := nuclear_oneplus3
